...
new class extends Component
{
    ...
    public function mount(Faculty $faculty): void
    {
        ...
        $this->tenant_id = $faculty->tenant_id;
    }
    ...
    public function save(): void
    {
        ...
        session()->flash('notify', ['type' => 'success', 'message' => 'Data fakultas berhasil diperbarui!']);
